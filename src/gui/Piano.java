...
public class Piano extends Canvas  {
	...
	// UNIKAT:
	// Dodata staticka jedina instanca klase
	private static Piano uniqueInstance = null;
	...
	// UNIKAT:
	// Dodata staticka metoda za dohvatanje jedinog primerka
	public static Piano instance() {
		if (uniqueInstance == null) {
			uniqueInstance = new Piano();
		}
		return uniqueInstance;
	}

	// UNIKAT:
	// Konstruktor postaje zasticen
	protected Piano() {
